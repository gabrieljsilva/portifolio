...
import { Box, Dialog, DialogProps, Typography, IconButton } from "@mui/material";
...
export function Modal({ title, open, onClose, children, showCloseButton = true, ...props }: ModalProps) {
  return (
